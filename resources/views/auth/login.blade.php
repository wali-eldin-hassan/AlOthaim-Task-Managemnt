    ...
    <form class="w-full max-w-md" action="/">
        ...
        <div class="mt-6">
            ...
            <p class="mt-6 text-sm text-center text-gray-400 dark:text-gray-300">
                {{ __('Don\'t have an account?') }} <a href="{{route('register')}}" class="text-indigo-500 dark:text-indigo-400 focus:outline-none focus:underline hover:underline">{{ __('Register') }}</a>.
            </p>
        </div>
    </form>
</x-guest-layout>