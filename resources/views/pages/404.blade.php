<x-guest-layout>
    <div class="flex flex-col items-center justify-center h-96">
        <h2 class="text-3xl font-semibold text-gray-800 dark:text-white md:text-4xl">{{__('Page not found')}}</h2>

        <div class="w-32 h-1 my-6 bg-gradient-to-r from-indigo-700 to-sky-600 md:my-6"></div>

        <p class="text-gray-500 dark:text-gray-400">{{ __('Sorry, the page you are looking for doesn\'t exist or has been moved') }}.</p>
