        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <div>
                <div class="flex items-center gap-x-3">
                    <h2 class="text-xl font-medium text-gray-800 dark:text-gray-200 sm:text-2xl">{{ __('Invoices') }}</h2>

                    <span class="px-3 py-1 text-xs text-indigo-600 bg-indigo-100 rounded-full dark:bg-gray-800 dark:text-indigo-400">240 items</span>
                </div>

                <p class="mt-3 text-sm text-gray-500 dark:text-gray-300">These companies have purchased in the last 12 months.</p>
            </div>
